...
//to configure file and pattern of it we need to call file
    ...
    //we use this method instead of send keys method through the framework
    ...
    //this method is gonna wait for element to be clickable
    ...
    //this method will perform click operation but before that it will wait for element to be clickable
