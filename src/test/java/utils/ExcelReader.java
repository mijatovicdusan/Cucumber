...
//this method will open excel work sheet

    public static void getSheet(String sheetName) {

        sheet = book.getSheet(sheetName);
    }
//this method will give row count

    public static int getRowCount() {

        return sheet.getPhysicalNumberOfRows();
    }
//this method will give column count

    public static int getColsCount(int rowIndex) {

        return sheet.getRow(rowIndex).getPhysicalNumberOfCells();
    }
//this method will give cell data in string format

    public static String getCellData(int rowIndex, int colIndex){

        return sheet.getRow(rowIndex).getCell(colIndex).toString();
    }
//this method will return list of maps having all data from excel sheet
